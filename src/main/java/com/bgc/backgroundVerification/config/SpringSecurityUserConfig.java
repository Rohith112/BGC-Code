...
public class SpringSecurityUserConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.antMatcher("/user/**").authorizeRequests()
				.antMatchers("/user/forgotPassword**","/user/forgotPassword/**","/js/**", "/css/**", "/icons/**", "/images/**", "/plugins/**", "/assets/**", "/scss/**").permitAll().anyRequest().hasRole("Candidate").and().formLogin().loginPage("/user/login")
